...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvmessage.adapter = MessageAdapter(this, messages)
        rvmessage.layoutManager = LinearLayoutManager(this)

        guessField = findViewById(R.id.Enterfield)
        guessButton = findViewById(R.id.Enterbtn)
        guessButton.setOnClickListener { addMessage() }

        tvPhrase = findViewById(R.id.phrase)
        tvLetters = findViewById(R.id.letters)
    ...
    private fun updateScore(){
        ...
        if(score >= highScore){
            ...
            Snackbar.make(rvMain, "NEW HIGH SCORE!", Snackbar.LENGTH_LONG).show()
        }
    }
